...
class Container extends React.Component {
  ...
  componentDidMount(props) {
    ...
    this.setState({
      menuDefaultId: arrIndex,
      currentUrl: pathname,
    });
    // console.log(location);
    // console.log(url);
    // console.log(getPathQueue(menus, url)[0]);
    console.log(this.state.menuDefaultId);
    ...
    return (
      <>
        <Header className="site-layout-background">
          ...
          <div style={{ fontSize: '24px', color: '#fff' }}>{this.state.currentUrl}</div>
        </Header>
        <Layout>
          <Sider
          ...
          >
            ...
            <Menu
              theme="dark"
              mode="inline"
              selectedKeys={[this.state.menuDefaultId.toString()]}
