...
const URL_SERVER_DOWNLOAD_FILE = 'headless/downloadfile';
...
export const postTimeSnap = params => http.post(URL_SERVER_TIMESNAP, params, '', params);
export const getTimeSnapPercent = params => http.get(URL_SERVER_GET_PERCENT_TIMESNAP, params);
export const destoryTimeSnap = params => http.get(URL_SERVER_GET_DESTORY_TIMESNAP, params);
export const postFetchPicUrl = params => http.post(URL_SERVER_DOWNLOAD_FILE, params, '', params);
